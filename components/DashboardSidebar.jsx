    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      <div className="p-6">
        <Link href="/" className="flex items-center group">
          <img src="/assets/logo.svg" alt="qlynk logo" className="h-10 w-auto" />
        </Link>
      </div>
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-colors ${
              pathname === item.href
                ...
                : 'text-panel-grey hover:bg-gray-100 hover:text-charcoal'
            }`}
          >
            <item.icon size={20} />
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          onClick={onSignOut}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-panel-grey hover:bg-gray-100 hover:text-charcoal font-semibold transition-colors"
        >
          <LogOut size={20} />
          <span>Log Out</span>
        </button>
