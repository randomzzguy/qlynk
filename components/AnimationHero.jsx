    ...
    class ParticleSystem {
      ...
      startCycle() {
        ...
        this.mockupElements.forEach((el, elementIndex) => {
          const targets = mockup.querySelectorAll(el.selector);
      ...
      updateMockupColors(theme) {
        const header = mockup.querySelector('.mockup-header');
        const nav = mockup.querySelector('.mockup-nav');
        const hero = mockup.querySelector('.mockup-hero');
        const sections = mockup.querySelectorAll('.mockup-section');
        const footer = mockup.querySelector('.mockup-footer');
